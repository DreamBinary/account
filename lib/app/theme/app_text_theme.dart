...
class AppTS {
  ...
  static TextStyle get minor => TextStyle(
        fontSize: version == 0 ? 10.sp : 12.sp,
        color: const Color(0xff3D3D3D),
      );

  static TextStyle get small => TextStyle(
      fontSize: version == 0 ? 16.sp : 19.sp, color: const Color(0xff3D3D3D));

  static TextStyle get normal => TextStyle(
      fontSize: version == 0 ? 20.sp : 24.sp, color: const Color(0xff3D3D3D));

  static TextStyle get big => TextStyle(
      fontSize: version == 0 ? 24.sp : 29.sp, color: const Color(0xff3D3D3D));

  static TextStyle get big32 => TextStyle(
      fontSize: version == 0 ? 32.sp : 40.sp, color: const Color(0xff3D3D3D));

  static TextStyle get large => TextStyle(
      fontSize: version == 0 ? 40.sp : 48.sp, color: const Color(0xff3D3D3D));
